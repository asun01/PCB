...
|---|---|---|
| T23-01 | contract/schema validation | expected assertion + evidence + trace; no silent pass |
| T23-02 | normal + boundary + reject | expected assertion + evidence + trace; no silent pass |
| T23-03 | replay/golden dataset | expected assertion + evidence + trace; no silent pass |
| T23-04 | fault injection | expected assertion + evidence + trace; no silent pass |
| T23-05 | performance benchmark | expected assertion + evidence + trace; no silent pass |
| T23-06 | real domain consumer | expected assertion + evidence + trace; no silent pass |
| T23-07 | hard-negative/false-positive set | expected assertion + evidence + trace; no silent pass |
