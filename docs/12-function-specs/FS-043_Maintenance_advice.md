...
**Fallback trigger：** Advice can fall back to “insufficient evidence”; it cannot convert missing trend data into a maintenance recommendation.

**Reject / Block conditions：** Insufficient trend history, inconsistent samples, missing maintenance context.
...
| Fallback | `No recommendation when evidence is insufficient` | Advice can fall back to “insufficient evidence”; it cannot convert missing trend data into a maintenance recommendation. |
| Reject / Block | `Insufficient trend history, inconsistent samples, missing maintenance context.` | 保留证据与原因；不得生成权威 OK。 |
...
| Fallback trigger | Advice can fall back to “insufficient evidence”; it cannot convert missing trend data into a maintenance recommendation. |
| Reject/Block | Insufficient trend history, inconsistent samples, missing maintenance context. |
