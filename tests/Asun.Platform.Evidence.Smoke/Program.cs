...
EvidenceCatalogSnapshotIntegrityReportHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogSnapshotChangeHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogSnapshotWindowIntegritySummaryHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogSnapshotWindowTransitionHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceSnapshotChainHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceDescriptorQueryHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogQueryRuntimeHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogQueryResultHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogQueryResultFingerprintHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogQueryIntegrationHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogQueryBatchHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogQueryBatchValidationHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogQueryBatchFingerprintHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogQueryBatchIntegrationHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogSnapshotWindowQueryHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogSnapshotWindowQueryValidationHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogSnapshotWindowQueryFingerprintHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogSnapshotWindowQueryIntegrationHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceReferenceSetHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceReferenceResolutionHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceReferenceResolutionValidationHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceReferenceResolutionFingerprintHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceReferenceClosureIntegrationHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogStatisticsHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogStatisticsValidationHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogStatisticsFingerprintHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogConsistencyReportHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogConsistencyIntegrationHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
...
EvidenceCatalogWindowDiagnosticBundleHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogWindowDiagnosticBundleValidationHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogWindowDiagnosticBundleFingerprintHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
EvidenceCatalogWindowDiagnosticIntegrationHundredStageSmoke.Run((condition,message)=>
{
    if(!condition)
        failures.Add(message);
});
