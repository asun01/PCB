...
public static class PcbExecutionRoiQualityReleaseAuditReplayClosure4HundredStageSmoke
{
    ...
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            var tampered=closure with { ReplayDescriptorFingerprint=H('z') };
            Check(!PcbExecutionRoiQualityReleaseAuditReplayClosureRuntime.IsValidClosure(left,audit,tampered),
                  "audit replay descriptor tamper must be rejected");
        }
