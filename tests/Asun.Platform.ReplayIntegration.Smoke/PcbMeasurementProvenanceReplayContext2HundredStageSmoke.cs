...
public static class PcbMeasurementProvenanceReplayContext2HundredStageSmoke
{
            ...
            for(var i1=0;i1<10;i1++)
            {
                ...
                Check(
                    !PcbMeasurementProvenanceReplayContextRuntime.IsValid(
                        fixture.MeasurementBinding,provenance,fixture.ProvenanceDescriptor) &&
                    (group1<9 || round==100),
                    "frame payload identity drift must be rejected");
            }
        }
