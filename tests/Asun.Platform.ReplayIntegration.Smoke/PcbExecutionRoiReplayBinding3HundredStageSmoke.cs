...
public static class PcbExecutionRoiReplayBinding3HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                ...
                var roi=fixture.PcbRoiBinding with
                {
                    QualityRunId=Guid.Parse("c5000000-0000-0000-0000-000000000001")
                };
                Check(
                    !PcbExecutionRoiReplayBindingRuntime.IsValid(
                        roi,fixture.ReplayConvergence) &&
                    (group1<9 || round==100),
                    "PCB/ROI Quality identity drift must be rejected");
            }
        }
