...
await ProductionMeasurementQualityEvidenceReleaseAuditReplayContext1HundredStageSmoke.RunAsync(Check);
await ProductionMeasurementQualityEvidenceReleaseAuditReplayContext2HundredStageSmoke.RunAsync(Check);
await ProductionMeasurementQualityEvidenceReleaseAuditReplayContext3HundredStageSmoke.RunAsync(Check);
await ProductionMeasurementQualityEvidenceReleaseAuditReplayContext4HundredStageSmoke.RunAsync(Check);
await ProductionMeasurementQualityEvidenceReleaseAuditReplayContext5HundredStageSmoke.RunAsync(Check);
await ProductionFrameMeasurementQualityReleaseReplayContext1HundredStageSmoke.RunAsync(Check);
await ProductionFrameMeasurementQualityReleaseReplayContext2HundredStageSmoke.RunAsync(Check);
await ProductionFrameMeasurementQualityReleaseReplayContext3HundredStageSmoke.RunAsync(Check);
await ProductionFrameMeasurementQualityReleaseReplayContext4HundredStageSmoke.RunAsync(Check);
await ProductionFrameMeasurementQualityReleaseReplayContext5HundredStageSmoke.RunAsync(Check);
...
await PcbMeasurementReplayComponentBinding1HundredStageSmoke.RunAsync(Check);
await PcbMeasurementReplayComponentBinding2HundredStageSmoke.RunAsync(Check);
await PcbMeasurementReplayComponentBinding3HundredStageSmoke.RunAsync(Check);
await PcbMeasurementReplayComponentBinding4HundredStageSmoke.RunAsync(Check);
await PcbMeasurementReplayComponentBinding5HundredStageSmoke.RunAsync(Check);
await PcbMeasurementProvenanceReplayContext1HundredStageSmoke.RunAsync(Check);
await PcbMeasurementProvenanceReplayContext2HundredStageSmoke.RunAsync(Check);
