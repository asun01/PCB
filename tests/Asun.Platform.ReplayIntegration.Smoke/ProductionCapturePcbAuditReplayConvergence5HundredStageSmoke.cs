...
public static class ProductionCapturePcbAuditReplayConvergence5HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group0=0;group0<10;group0++)
        {
            round++;
                ...
                var invalidFingerprint=fixture.Pcb with { Fingerprint="invalid" };
                var blankArtifact=fixture.Pcb with { ArtifactPath="" };
                Check(!ProductionCapturePcbAuditReplayConvergenceRuntime.IsValid(fixture.Capture,invalidFingerprint) &&
                      !ProductionCapturePcbAuditReplayConvergenceRuntime.IsValid(fixture.Capture,blankArtifact) &&
                      (group0<9 || round==100),
                      "PCB audit replay malformed identity and blank artifact path must be rejected");
        }
