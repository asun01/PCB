...
public static class ProductionReleaseCandidatePcbAuditReplayClosure1HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        var sessionId=Guid.Parse("F10000000-0000-0000-0000-000000000001");
        var qualityRunId=Guid.Parse("F11000000-0000-0000-0000-000000000001");
        var manifest=ReleaseManifestRuntime.Create(
            new ReleaseIdentity("Asun PCB Release Candidate",new Version(1,0,1),"audit"),
            new[]{new ReleaseArtifact("release/audit/1.logical",new string('a',64),20+1)});
        ...
        var closure=ProductionReleaseCandidatePcbAuditReplayClosureRuntime.Create(
            ...
            pcbAuditReplay,
            manifest);
        var tampered=closure with {ReleaseManifestFingerprint=new string('9',64)};
        ...
        assert(round==100,$"ProductionReleaseCandidatePcbAuditReplayClosure1HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
