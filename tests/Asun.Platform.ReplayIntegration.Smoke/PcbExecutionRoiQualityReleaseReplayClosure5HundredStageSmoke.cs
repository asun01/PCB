...
public static class PcbExecutionRoiQualityReleaseReplayClosure5HundredStageSmoke
{
    ...
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            round++;
                ...
                var left=PcbExecutionRoiQualityReleaseReplayClosureRuntime.Create(binding,release);
