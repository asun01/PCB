...
public static class PcbExecutionRoiQualityReleaseAuditReplayClosure5HundredStageSmoke
{
    ...
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            var a=PcbExecutionRoiQualityReleaseAuditReplayClosureRuntime.Create(left,audit);
            var b=PcbExecutionRoiQualityReleaseAuditReplayClosureRuntime.Create(left,audit);
            var tampered=a with { ClosureFingerprint=H('z') };
            Check(PcbExecutionRoiQualityReleaseAuditReplayClosureRuntime.IsEquivalent(a,b) &&
                  !PcbExecutionRoiQualityReleaseAuditReplayClosureRuntime.IsEquivalent(a,tampered),
                  "equivalent audit closures must converge while tampering remains distinguishable");
        }
