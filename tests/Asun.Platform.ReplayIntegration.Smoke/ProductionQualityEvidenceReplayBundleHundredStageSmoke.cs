...
public static class ProductionQualityEvidenceReplayBundleHundredStageSmoke
{
    public static async ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        var program=new InspectionProgram(
            ...
            new Version(1,0,0),
            new[]{
                new ProgramStep(Guid.Parse("7D000000-0000-0000-0000-000000000001"),1,ProgramStepKind.Acquire,"Acquire",Array.Empty<ProgramParameter>()),
                new ProgramStep(Guid.Parse("7D000000-0000-0000-0000-000000000002"),2,ProgramStepKind.Measure,"Measure",Array.Empty<ProgramParameter>())
            });
            ...
            new[]{
                new QualityInspectionResult(
                    ...
                    new QualityInspectionSnapshot(
                        ...
                        1,
                        new QualityFindingSet(new[]{new QualityFinding(QualityFindingId.Create("REPLAY.INFO"),QualityOutcome.Informational,QualitySeverity.Information,"Replay frame 1 observed")}),
                ...
                new QualityInspectionResult(
                    ...
                    new QualityInspectionSnapshot(
                        ...
                        2,
                        new QualityFindingSet(new[]{new QualityFinding(QualityFindingId.Create("REPLAY.INFO"),QualityOutcome.Informational,QualitySeverity.Information,"Replay frame 2 observed")}),
                        new QualityFindingEvidenceSet(Array.Empty<QualityFindingEvidenceLink>())))
            });
        var evidence=ProductionEvidenceReferenceProjectionRuntime.Create(
            production,
            new[]{
                new ProductionEvidenceFrameReference(1,new[]{EvidenceHandle.Create("replay/frame/1/input")}),
                new ProductionEvidenceFrameReference(2,new[]{EvidenceHandle.Create("replay/frame/2/input")})
            });
        var bundle=ProductionQualityEvidenceReplayBundleRuntime.Create(
            ...
            qualityRun,
            evidence);
        var tampered=bundle with {EvidenceProjectionFingerprint=new string('a',64)};
            ...
            new[]{
                new QualityInspectionResult(
                    ...
                    new QualityInspectionSnapshot(
                        ...
                        2,
                        new QualityFindingSet(new[]{new QualityFinding(QualityFindingId.Create("REPLAY.INFO"),QualityOutcome.Informational,QualitySeverity.Information,"Shifted")}),
                        new QualityFindingEvidenceSet(Array.Empty<QualityFindingEvidenceLink>())),
                new QualityInspectionResult(
