...
public static class PcbEvidenceReleaseAuditTraceReplayDescriptor3HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        assert(round==100,$"PcbEvidenceReleaseAuditTraceReplayDescriptor3HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
