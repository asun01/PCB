...
public static class PcbEvidenceReleaseAuditTraceReplayDescriptor4HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        assert(round==100,$"PcbEvidenceReleaseAuditTraceReplayDescriptor4HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
