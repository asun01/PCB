...
public static class ProductionCapturePcbAuditReplayConvergence3HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group0=0;group0<10;group0++)
        {
            round++;
                ...
                var tampered=fixture.Pcb with { QualityRunId=Guid.Parse("00000000-0000-0000-0000-000000000998") };
                Check(!ProductionCapturePcbAuditReplayConvergenceRuntime.IsValid(fixture.Capture,tampered) &&
                      (group0<9 || round==100),
                      "Quality run identity drift must be rejected");
        }
