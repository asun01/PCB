...
public static class ProductionReleaseCandidatePcbAuditReplayClosure4HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        var sessionId=Guid.Parse("F40000000-0000-0000-0000-000000000001");
        var qualityRunId=Guid.Parse("F41000000-0000-0000-0000-000000000001");
        var manifest=ReleaseManifestRuntime.Create(
            new ReleaseIdentity("Asun PCB Release Candidate",new Version(1,0,4),"audit"),
            new[]{new ReleaseArtifact("release/audit/4.logical",new string('a',64),20+4)});
        ...
        var closure=ProductionReleaseCandidatePcbAuditReplayClosureRuntime.Create(
            ...
            pcbAuditReplay,
            manifest);
        var tamperedDescriptor=pcbAuditReplay with {TransitionFingerprint=new string('8',64)};
        ...
        assert(round==100,$"ProductionReleaseCandidatePcbAuditReplayClosure4HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
