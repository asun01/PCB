...
public static class ProductionCapturePcbAuditReplayConvergence2HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group0=0;group0<10;group0++)
        {
            round++;
                ...
                var tampered=fixture.Capture with { ProductionSessionId=Guid.Parse("00000000-0000-0000-0000-000000000999") };
                Check(!ProductionCapturePcbAuditReplayConvergenceRuntime.IsValid(tampered,fixture.Pcb) &&
                      (group0<9 || round==100),
                      "Production session identity drift must be rejected");
        }
