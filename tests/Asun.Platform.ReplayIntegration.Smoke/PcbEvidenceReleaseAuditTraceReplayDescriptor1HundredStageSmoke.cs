...
public static class PcbEvidenceReleaseAuditTraceReplayDescriptor1HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        assert(round==100,$"PcbEvidenceReleaseAuditTraceReplayDescriptor1HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
