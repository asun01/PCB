...
public static class ProductionCaptureEvidenceAuditReplayConvergence2HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group0=0;group0<10;group0++)
        {
            round++;
                ...
                var tampered=fixture.Descriptor with { TraceFingerprint = "2222222222222222222222222222222222222222222222222222222222222222" };
                Check(!ProductionCaptureEvidenceAuditReplayConvergenceRuntime.IsValid(fixture.Binding,tampered) &&
                      (group0<9 || round==100),
                      "trace identity drift must be rejected");
        }
