...
public static class ProductionReleaseCandidatePcbAuditReplayClosure3HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        var sessionId=Guid.Parse("F30000000-0000-0000-0000-000000000001");
        var qualityRunId=Guid.Parse("F31000000-0000-0000-0000-000000000001");
        var manifest=ReleaseManifestRuntime.Create(
            new ReleaseIdentity("Asun PCB Release Candidate",new Version(1,0,3),"audit"),
            new[]{new ReleaseArtifact("release/audit/3.logical",new string('a',64),20+3)});
        ...
        var closure=ProductionReleaseCandidatePcbAuditReplayClosureRuntime.Create(
            ...
            pcbAuditReplay,
            manifest);
        var tampered=closure with {ArtifactPath="release/audit/drift.logical"};
        ...
        assert(round==100,$"ProductionReleaseCandidatePcbAuditReplayClosure3HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
