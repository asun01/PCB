...
public static class PcbExecutionRoiReplayBinding1HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                ...
                var binding=PcbExecutionRoiReplayBindingRuntime.Create(
                    fixture.PcbRoiBinding,fixture.ReplayConvergence);
                Check(
                    PcbExecutionRoiReplayBindingRuntime.IsValid(
                        fixture.PcbRoiBinding,fixture.ReplayConvergence) &&
                    binding.ProductionSessionId==fixture.PcbRoiBinding.ProductionSessionId &&
                    binding.QualityRunId==fixture.PcbRoiBinding.QualityRunId &&
                    PcbExecutionRoiReplayBindingRuntime.IsReleaseReady(binding) &&
                    binding.BindingFingerprint.Length==64 &&
                    (group1<9 || round==100),
                    "valid PCB/ROI replay binding must be accepted");
            }
        }
