...
public static class PcbExecutionRoiQualityReleaseAuditReplayClosure1HundredStageSmoke
{
    ...
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            var closure=PcbExecutionRoiQualityReleaseAuditReplayClosureRuntime.Create(left,audit);
            Check(PcbExecutionRoiQualityReleaseAuditReplayClosureRuntime.IsValidClosure(left,audit,closure) &&
                  closure.ProductionSessionId==left.ProductionSessionId &&
                  closure.QualityRunId==left.QualityRunId &&
                  closure.ClosureFingerprint.Length==64,
                  "clean ROI quality release audit replay closure must be valid");
        }
