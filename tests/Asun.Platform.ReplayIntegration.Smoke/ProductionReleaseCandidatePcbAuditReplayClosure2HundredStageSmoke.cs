...
public static class ProductionReleaseCandidatePcbAuditReplayClosure2HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        var sessionId=Guid.Parse("F20000000-0000-0000-0000-000000000001");
        var qualityRunId=Guid.Parse("F21000000-0000-0000-0000-000000000001");
        var manifest=ReleaseManifestRuntime.Create(
            new ReleaseIdentity("Asun PCB Release Candidate",new Version(1,0,2),"audit"),
            new[]{new ReleaseArtifact("release/audit/2.logical",new string('a',64),20+2)});
        ...
        var closure=ProductionReleaseCandidatePcbAuditReplayClosureRuntime.Create(
            ...
            pcbAuditReplay,
            manifest);
        var tampered=closure with {QualityRunId=Guid.Parse("FA000000-0000-0000-0000-000000000009")};
        ...
        for(var i=0;i<10;i++) Check(!ProductionReleaseCandidatePcbAuditReplayClosureRuntime.IsValid(releaseCandidateAudit,pcbAuditReplay,manifest,tampered),"Cross-chain tampering should be rejected.");

        assert(round==100,$"ProductionReleaseCandidatePcbAuditReplayClosure2HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
