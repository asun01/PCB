...
public static class ProductionMeasurementQualityEvidenceReleaseAuditReplayContext1HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                ...
                var context=ProductionMeasurementQualityEvidenceReleaseAuditReplayContextRuntime.Create(
                ...
                Check(
                    ProductionMeasurementQualityEvidenceReleaseAuditReplayContextRuntime.IsValid(
                        fixture.ReplayDescriptor,fixture.AuditBinding) &&
                    context.Sequence==1 &&
                    context.AuditSequence==7 &&
                    context.QualityResultId==fixture.ReplayDescriptor.QualityResultId &&
                    context.ReleaseManifestFingerprint==fixture.ReplayDescriptor.ReleaseManifestFingerprint &&
                    context.BindingFingerprint.Length==64 &&
                    (group1<9 || round==100),
                    "valid quality/evidence/release audit replay context must be accepted");
            }
        }
