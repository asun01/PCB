...
public static class ProductionCapturePcbAuditReplayConvergence4HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group0=0;group0<10;group0++)
        {
            round++;
                ...
                var tampered=fixture.Pcb with { ReleaseManifestFingerprint="9999999999999999999999999999999999999999999999999999999999999999" };
