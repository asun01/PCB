    ...
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group0=0;group0<10;group0++)
        {
            for(var i0=0;i0<10;i0++)
            {
                ...
                {
                    ReleaseManifestFingerprint="aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
                };
                Check(
                    !ProductionMeasurementQualityEvidenceReleaseAuditReplayContextRuntime.IsValid(
                        descriptor,fixture.AuditBinding) &&
                    (group0<9 || round==100),
                    "Release manifest drift must be rejected");
            }
        }
