...
public static class PcbMeasurementReplayComponentBinding5HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                ...
                var left=PcbMeasurementReplayComponentBindingRuntime.Create(
                    fixture.ExecutionBinding,fixture.MeasurementBindings,fixture.ReplayDescriptors);
                var right=PcbMeasurementReplayComponentBindingRuntime.Create(
                    fixture.ExecutionBinding,fixture.MeasurementBindings,fixture.ReplayDescriptors);
                Check(
                    PcbMeasurementReplayComponentBindingRuntime.IsEquivalent(left,right) &&
                    left.ReplayDescriptorFingerprints.SequenceEqual(right.ReplayDescriptorFingerprints) &&
                    left.ComponentIds.SequenceEqual(right.ComponentIds) &&
                    (group1<9 || round==100),
                    "equivalent measurement/component replay inputs must converge");
            }
        }
