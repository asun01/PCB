...
public static class PcbMeasurementReplayComponentBinding1HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                ...
                var binding=PcbMeasurementReplayComponentBindingRuntime.Create(
                ...
                Check(
                    PcbMeasurementReplayComponentBindingRuntime.IsValid(
                        fixture.ExecutionBinding,fixture.MeasurementBindings,fixture.ReplayDescriptors) &&
                    binding.MeasurementCount==2 &&
                    binding.ComponentIds.SequenceEqual(new[]{"C1-ID","R1-ID"}) &&
                    binding.ReleaseManifestFingerprint.All(char.IsLetterOrDigit) &&
                    binding.BindingFingerprint.Length==64 &&
                    binding.ReleaseReady &&
                    (group1<9 || round==100),
                    "valid measurement/component replay binding must be accepted");
            }
        }
