...
public static class PcbMeasurementProvenanceReplayContext1HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                ...
                var context=PcbMeasurementProvenanceReplayContextRuntime.Create(
                ...
                Check(
                    PcbMeasurementProvenanceReplayContextRuntime.IsValid(
                        fixture.MeasurementBinding,fixture.Provenance,fixture.ProvenanceDescriptor) &&
                    context.Sequence==1 &&
                    context.ComponentId=="U1-ID" &&
                    context.Width==1280 &&
                    context.Height==960 &&
                    context.BindingFingerprint.Length==64 &&
                    (group1<9 || round==100),
                    "valid measurement/component/frame provenance replay context must be accepted");
            }
        }
