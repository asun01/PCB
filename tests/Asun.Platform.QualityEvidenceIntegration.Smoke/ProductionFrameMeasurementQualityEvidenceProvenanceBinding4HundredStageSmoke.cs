...
public static class ProductionFrameMeasurementQualityEvidenceProvenanceBinding4HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                round++;
                var evidence=i1%2==0
                    ? FrameMeasurementQualityEvidenceFixtureRuntime.Create().EvidenceBinding with
                    {
                ...
                Check(
                    ...
                    (group1<9 || round==100),
                    "Evidence fingerprint or binding identity drift must be rejected");
            }
        }
