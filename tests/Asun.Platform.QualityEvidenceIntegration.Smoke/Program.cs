...
await ProductionFrameMeasurementQualityEvidenceProvenanceBinding1HundredStageSmoke.RunAsync(Check);
await ProductionFrameMeasurementQualityEvidenceProvenanceBinding2HundredStageSmoke.RunAsync(Check);
await ProductionFrameMeasurementQualityEvidenceProvenanceBinding3HundredStageSmoke.RunAsync(Check);
await ProductionFrameMeasurementQualityEvidenceProvenanceBinding4HundredStageSmoke.RunAsync(Check);
await ProductionFrameMeasurementQualityEvidenceProvenanceBinding5HundredStageSmoke.RunAsync(Check);
