...
public static class CaptureSessionProductionEvidenceBinding3HundredStageSmoke
{
    public static async ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        var frames=new[]{frame1,frame2,frame3,frame4};
        ...
        for(var i=0;i<10;i++) Check(binding.FrameCount==4,"Binding should preserve Evidence frame count.");
        ...
        for(var i=0;i<10;i++) Check(provenance.Count==4,"Every Production frame should have matching provenance.");
        for(var i=0;i<10;i++) Check(evidenceReferences.Select(reference=>reference.Sequence).SequenceEqual(Enumerable.Range(1,4)),"Evidence reference sequences should remain contiguous.");
        ...
        assert(round==100,$"CaptureSessionProductionEvidenceBinding3HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
    }
}
