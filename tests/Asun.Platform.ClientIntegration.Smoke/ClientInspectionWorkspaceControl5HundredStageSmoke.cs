...
public static class ClientInspectionWorkspaceControl5HundredStageSmoke
{
    ...
    public static async Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var i0=0;i0<10;i0++)
        {
            round++;
                ...
                var completed=await client.ExecuteAsync(
                ...
                Check(snapshot.Production.Status==ClientExecutionStatus.Completed &&
                      snapshot.Production.LastFrameCount==completed.FrameCount &&
                      snapshot.History.Entries.Count==1,
                      "cancelling after completion must not invalidate an already completed client result");
        }
