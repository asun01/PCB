...
public static class ClientInspectionExecutionRecovery5HundredStageSmoke
{
    ...
    public static async Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            workspace.LoadProgram(
                ...
                Guid.Parse("88000000-0000-0000-0000-000000000105"),
                3);
            ...
            Check(changes>0 &&
                  workspace.Production.Status==ClientExecutionStatus.Completed &&
                  workspace.History.Entries.Count==1,
                  "recovery must propagate client state changes and close on the recovered run");
        }
