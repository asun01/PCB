...
public static class ClientRoiInteractionWorkspace1HundredStageSmoke
{
    public static async Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var i0=0;i0<10;i0++)
        {
            round++;
                ...
                Check(roi.State==ViewportPresentationState.Running &&
                      snapshot.ProductionSessionId==report.SessionId &&
                      snapshot.RoiCount==0 &&
                      snapshot.SelectedRoiId is null &&
                      snapshot.RoiFingerprint.Length==64 &&
                      snapshot.InteractionFingerprint.Length==64,
                      "bound Production report should start a valid empty ROI interaction workspace");
        }
