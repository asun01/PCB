...
public static class ClientInspectionExecutionRecovery1HundredStageSmoke
{
    ...
    public static async Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            workspace.LoadProgram(
                ...
                Guid.Parse("88000000-0000-0000-0000-000000000101"),
                3);
            ...
            Check(failed &&
                  snapshot.Production.Status==ClientExecutionStatus.Failed &&
                  snapshot.Replay is null &&
                  snapshot.Release is null,
                  "failed Production execution must not leave stale Replay or Release projections");
        }
