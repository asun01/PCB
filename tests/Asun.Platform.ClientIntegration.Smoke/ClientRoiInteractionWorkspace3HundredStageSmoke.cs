...
public static class ClientRoiInteractionWorkspace3HundredStageSmoke
{
    public static async Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var i0=0;i0<10;i0++)
        {
            round++;
                ...
                var stableId=Guid.Parse("75000000-0000-0000-0000-000000000001");
                roi.AddRectangle(new Vector2(50,50),new Vector2(20,20),stableId);
                var context=roi.CaptureProductionContext();
                Check(context.ProductionSessionId==report.SessionId &&
                      context.RoiCount==1 &&
                      context.SelectedRoiId==stableId &&
                      context.RoiFingerprint.Length==64 &&
                      context.BindingFingerprint.Length==64,
                      "ROI context should preserve Production identity and deterministic ROI identity");
        }
