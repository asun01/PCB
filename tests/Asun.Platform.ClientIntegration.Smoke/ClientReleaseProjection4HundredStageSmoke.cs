...
public static class ClientReleaseProjection4HundredStageSmoke
{
    public static async Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var i0=0;i0<10;i0++)
        {
            round++;
                ...
                var right=ClientReleaseProjectionRuntime.Create(replay,ClientWorkspaceSmokeFixture.CreateReleaseManifest());
                Check(ClientReleaseProjectionRuntime.IsEquivalent(left,right),
                      "equivalent client Release projections must converge deterministically");
        }
