...
public static class ClientProductionProgress5HundredStageSmoke
{
    ...
    public static async Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            Check(cancelled &&
                  workspace.Snapshot.Status==ClientExecutionStatus.Cancelled &&
                  workspace.Snapshot.FramesProcessed==1,
                  "cancellation must preserve the latest accepted progress while changing execution status");
        }
