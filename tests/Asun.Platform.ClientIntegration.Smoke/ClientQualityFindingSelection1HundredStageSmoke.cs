...
public static class ClientQualityFindingSelection1HundredStageSmoke
{
    ...
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            Check(snapshot.SelectedFindingId=="F-001" &&
                  workspace.SelectFinding("F-001") &&
                  workspace.Capture().SelectedFindingId=="F-001",
                  "Quality Run binding must establish a deterministic finding selection");
        }
