...
public static class ClientProductionRunHistory5HundredStageSmoke
{
        ...
        for(var i0=0;i0<10;i0++)
        {
            round++;
                ...
                Check(snapshot.Capacity==2 &&
                      snapshot.NextOrdinal==2 &&
                      snapshot.Entries[0].ProgramId==definition.ProgramPlan.ProgramId &&
                      snapshot.Entries[0].ArtifactPath=="simulation/release.pcb",
                      "history snapshot should expose deterministic client result identity");
        }
