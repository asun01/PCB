...
public static class ClientResultsPresentation2HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            Check(result.Status=="Idle" &&
                  result.FrameCount==0 &&
                  result.SessionText=="Session not loaded",
                  "idle client state must project a non-loaded result");
        }
