...
public static class ClientRoiHistoryControl2HundredStageSmoke
{
    public static async Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var i0=0;i0<10;i0++)
        {
            round++;
                ...
                var undone=client.UndoRoi();
                var snapshot=client.Capture();
                Check(undone &&
                      !snapshot.CanUndoRoi &&
                      snapshot.CanRedoRoi &&
                      snapshot.Roi!.RoiCount==0,
                      "Undo should remove the ROI and expose Redo");
        }
