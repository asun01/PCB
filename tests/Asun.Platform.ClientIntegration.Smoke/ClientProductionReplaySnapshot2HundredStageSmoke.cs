...
public static class ClientProductionReplaySnapshot2HundredStageSmoke
{
    public static async Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var i0=0;i0<10;i0++)
        {
            round++;
                ...
                var tampered=report with { Fingerprint=new string('a',64) };
                Check(!ClientProductionReplaySnapshotRuntime.IsValid(workspace.Snapshot,tampered),
                      "Production report fingerprint drift must be rejected at the client replay boundary");
        }
