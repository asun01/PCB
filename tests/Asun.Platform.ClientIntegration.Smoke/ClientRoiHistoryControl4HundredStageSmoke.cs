...
public static class ClientRoiHistoryControl4HundredStageSmoke
{
    public static async Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var i0=0;i0<10;i0++)
        {
            round++;
                ...
                Check(!client.UndoRoi() && !client.RedoRoi(),
                      "Undo and Redo should be safe no-ops when there is no ROI history");
        }
