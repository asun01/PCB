...
public static class ClientQualityFindingSelection2HundredStageSmoke
{
    ...
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            workspace.Bind(Run());
            var selected=workspace.SelectFinding("F-002");
            Check(selected &&
                  workspace.Capture().SelectedFindingId=="F-002",
                  "Quality finding selection must update the client context");
        }
