...
public static class ClientQualityFindingSelection4HundredStageSmoke
{
    ...
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            workspace.Bind(Run());
            workspace.Clear();
            Check(workspace.Capture().SelectedFindingId is null &&
                  !workspace.Capture().IsBound,
                  "Quality clear must remove the selected finding context");
        }
