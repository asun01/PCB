...
public static class ClientRunHistoryPresentation2HundredStageSmoke
{
    ...
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var i0=0;i0<10;i0++)
        {
            round++;
                ...
                var items=ClientRunHistoryPresentationRuntime.CreateItems(snapshot,2);
                Check(items.Count==2 &&
                      items[0].Ordinal==3 &&
                      items[1].Ordinal==2,
                      "history presentation should return newest ordinals first and honor max item count");
        }
