...
public static class ClientQualitySessionBoundary4HundredStageSmoke
{
    ...
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            var workspace=new ClientInspectionWorkspace(
                ...
                new Vector2(100,100));
            var changed=0;
            workspace.ProductionChanged+=_=>changed++;
            workspace.BindQualityRun(QualityRun());
            Check(workspace.Quality.IsBound &&
                  workspace.Quality.RunId==Guid.Parse("85000000-0000-0000-0000-000000000001") &&
                  changed==1,
                  "binding Quality must immediately publish a client refresh event");
        }
