...
public static class ClientSimulationQualityEvaluation4HundredStageSmoke
{
    public static async Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            workspace.LoadProgram(
                ...
                Guid.Parse("89000000-0000-0000-0000-000000000104"),
                3);
            var failed=false;
            try
            {
            ...
            Check(failed &&
                  ...
                  "Quality evaluation must require a completed Production report");
        }
