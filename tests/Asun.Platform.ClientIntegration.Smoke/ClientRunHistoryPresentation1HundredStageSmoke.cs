...
public static class ClientRunHistoryPresentation1HundredStageSmoke
{
    ...
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var i0=0;i0<10;i0++)
        {
            round++;
                ...
                Check(items.Count==3 &&
                      items.All(item=>item.SessionText.StartsWith("Session ")) &&
                      items.All(item=>item.ReplayText.StartsWith("Replay ")),
                      "history presentation should produce bounded display items from diagnostic history");
        }
