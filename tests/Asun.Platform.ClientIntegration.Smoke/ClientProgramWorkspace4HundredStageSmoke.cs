...
public static class ClientProgramWorkspace4HundredStageSmoke
{
    ...
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            try
            {
                workspace.CreateSessionDefinition(Guid.Empty,Pipeline(),1);
            }
            ...
            Check(failed,
                  "empty Production session identity must be rejected by the client program boundary");
        }
