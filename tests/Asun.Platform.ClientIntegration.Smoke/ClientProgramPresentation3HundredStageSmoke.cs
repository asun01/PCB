...
public static class ClientProgramPresentation3HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            var items=ClientProgramPresentationRuntime.CreateItems(workspace.CurrentProgram);
            Check(workspace.Snapshot.Status==ClientProgramLoadStatus.Ready &&
                  items.Count==0,
                  "A valid empty-step client program must remain a valid presentation projection");
        }
