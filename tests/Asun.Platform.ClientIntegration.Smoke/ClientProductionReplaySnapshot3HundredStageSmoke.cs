...
public static class ClientProductionReplaySnapshot3HundredStageSmoke
{
    public static async Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var i0=0;i0<10;i0++)
        {
            round++;
                ...
                var invalid=workspace.Snapshot with { Status=ClientExecutionStatus.Ready };
                Check(!ClientProductionReplaySnapshotRuntime.IsValid(invalid,report),
                      "incomplete client execution state must not be presented as replayable");
        }
