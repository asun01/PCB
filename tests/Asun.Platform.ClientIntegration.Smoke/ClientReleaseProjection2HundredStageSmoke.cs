...
public static class ClientReleaseProjection2HundredStageSmoke
{
    public static async Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var i0=0;i0<10;i0++)
        {
            round++;
                ...
                var manifest=ClientWorkspaceSmokeFixture.CreateReleaseManifest(valid:false);
                Check(!ClientReleaseProjectionRuntime.IsValid(replay,manifest),
                      "invalid Release manifest must not reach the client Release projection");
        }
