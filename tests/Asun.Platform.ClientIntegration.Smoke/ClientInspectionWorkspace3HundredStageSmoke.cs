...
public static class ClientInspectionWorkspace3HundredStageSmoke
{
    public static async Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var i0=0;i0<10;i0++)
        {
            round++;
                ...
                client.StopRoiInteraction();
                var viewport=client.CaptureRoiViewport();
                Check(viewport.Items.Count==1 &&
                      client.Capture().Production.ActiveSessionId==report.SessionId,
                      "stopping ROI input must preserve the current client session identity and ROI document");
        }
