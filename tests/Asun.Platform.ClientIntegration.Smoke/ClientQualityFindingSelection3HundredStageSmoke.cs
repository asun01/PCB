...
public static class ClientQualityFindingSelection3HundredStageSmoke
{
    ...
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            workspace.Bind(Run());
            var selected=workspace.SelectFinding("UNKNOWN");
            Check(!selected &&
                  workspace.Capture().SelectedFindingId=="F-001",
                  "unknown Quality finding identity must not replace the current selection");
        }
