...
public static class ClientWorkspaceRuntime2HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            var changed=false;
            runtime.Changed+=selection=>changed=selection.Workspace==ClientWorkspaceKind.Inspection;
            var navigated=runtime.TryNavigate(ClientWorkspaceKind.Inspection);
            Check(navigated && changed &&
