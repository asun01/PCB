...
public static class ClientInspectionWorkspace5HundredStageSmoke
{
    public static async Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var i0=0;i0<10;i0++)
        {
            ...
            var definition1=ClientWorkspaceSmokeFixture.CreateDefinition(Guid.Parse("76000000-0000-0000-0000-000000000001"));
            client.Load(definition1);
            await client.ExecuteAsync(
                new Asun.Device.Impl.SimulatedFrameSource(8,8),
                ClientWorkspaceSmokeFixture.CreateReleaseManifest());

            var definition2=ClientWorkspaceSmokeFixture.CreateDefinition(Guid.Parse("76000000-0000-0000-0000-000000000002"));
            client.Load(definition2);
            await client.ExecuteAsync(
                new Asun.Device.Impl.SimulatedFrameSource(8,8),
                ClientWorkspaceSmokeFixture.CreateReleaseManifest());

            var definition3=ClientWorkspaceSmokeFixture.CreateDefinition(Guid.Parse("76000000-0000-0000-0000-000000000003"));
            client.Load(definition3);
            await client.ExecuteAsync(
                new Asun.Device.Impl.SimulatedFrameSource(8,8),
                ClientWorkspaceSmokeFixture.CreateReleaseManifest());
