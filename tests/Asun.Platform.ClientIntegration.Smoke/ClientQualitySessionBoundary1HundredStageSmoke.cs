...
public static class ClientQualitySessionBoundary1HundredStageSmoke
{
    ...
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            workspace.LoadProgram(
                ...
                Guid.Parse("85000000-0000-0000-0000-000000000301"),
                3);
            Check(!workspace.Quality.IsBound,
                  "loading a new Program/Production context must clear stale Quality state");
        }
