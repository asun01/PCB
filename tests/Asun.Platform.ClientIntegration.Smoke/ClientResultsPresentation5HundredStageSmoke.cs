...
public static class ClientResultsPresentation5HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            var snapshot=new ClientInspectionWorkspaceSnapshot(
                new ClientWorkspaceSnapshot(null,null,null,ClientExecutionStatus.Failed,0,null,"failure"),
                null,null,null,
            ...
            Check(result.Status=="Failed" &&
                  ...
                  "failed execution must remain a failed result without release claims");
        }
