...
public static class ClientInspectionWorkflow4HundredStageSmoke
{
            ...
            i+1,Guid.NewGuid(),Guid.NewGuid(),3,new string((char)('a'+i),64),true,"artifact")).ToArray()))
{
    ...
    Quality=new ClientQualityWorkspaceSnapshot(
        ...
        Array.Empty<ClientQualityFindingDisplayItem>())
            ...
            Check(workflow.Step==ClientWorkflowStep.ReviewQuality &&
                  !workflow.CanAct &&
                  workflow.Message.Contains("Quality"),
                  "Completed Production without Quality must wait for an authoritative Quality Run");
        }
