...
public static class ClientHomePresentation4HundredStageSmoke
{
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            var snapshot=new ClientInspectionWorkspaceSnapshot(
                new ClientWorkspaceSnapshot(
                    ...
                    ClientExecutionStatus.Failed,0,null,"fault"),
                null,null,null,
            ...
            Check(home.ProductionStatus=="Failed" &&
                  home.AcquisitionStatus.Contains("Faulted"),
                  "Home overview must expose failure state without hiding it");
        }
