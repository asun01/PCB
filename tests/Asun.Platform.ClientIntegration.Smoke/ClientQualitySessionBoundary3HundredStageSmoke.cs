...
public static class ClientQualitySessionBoundary3HundredStageSmoke
{
    ...
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var iteration0=0;iteration0<10;iteration0++)
        {
            ...
            Check(!workspace.Quality.IsBound && changed==1,
                  "clearing Quality must immediately publish a client refresh event");
        }
