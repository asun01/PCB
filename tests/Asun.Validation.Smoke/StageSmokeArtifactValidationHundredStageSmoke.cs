...
""";
        ...
        for(var i=0;i<10;i++) Check(report.IsValid,$"valid artifact round {i+1} should pass.");
        for(var i=0;i<10;i++) Check(report.LoopGroups==10,$"loop count round {i+1} should be ten.");
        for(var i=0;i<10;i++) Check(report.CheckCalls==10,$"check count round {i+1} should be ten.");
        for(var i=0;i<10;i++) Check(report.RoundAssertions==1,$"round assertion count round {i+1} should be one.");
        for(var i=0;i<10;i++) Check(report.BalancedDelimiters,$"delimiter balance round {i+1} should pass.");
