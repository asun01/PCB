...
public static class PcbExecutionRoiContextBinding1HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                ...
                var binding=PcbExecutionRoiContextBindingRuntime.Create(
                    fixture.ExecutionSnapshot,fixture.RoiContext);
                Check(
                    PcbExecutionRoiContextBindingRuntime.IsValid(
                        fixture.ExecutionSnapshot,fixture.RoiContext) &&
                    PcbExecutionRoiContextBindingRuntime.IsValidBinding(binding) &&
                    binding.ProductionSessionId==fixture.ExecutionSnapshot.ProductionSessionId &&
                    binding.QualityRunId==fixture.ExecutionSnapshot.QualityRunId &&
                    binding.BindingFingerprint.Length==64 &&
                    (group1<9 || round==100),
                    "valid PCB execution and ROI context must bind");
            }
        }
