...
public static class PcbExecutionRoiContextBinding3HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                ...
                {
                    ProductionFingerprint="9999999999999999999999999999999999999999999999999999999999999999"
                };
                Check(
                    !PcbExecutionRoiContextBindingRuntime.IsValid(
                        fixture.ExecutionSnapshot,roi) &&
                    (group1<9 || round==100),
                    "Production fingerprint drift must be rejected");
            }
        }
