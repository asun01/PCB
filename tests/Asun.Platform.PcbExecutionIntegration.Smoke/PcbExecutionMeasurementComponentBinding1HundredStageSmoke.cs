...
public static class PcbExecutionMeasurementComponentBinding1HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                ...
                var binding=PcbExecutionMeasurementComponentBindingRuntime.Create(
                ...
                Check(
                    PcbExecutionMeasurementComponentBindingRuntime.IsValid(
                        fixture.ExecutionSnapshot,fixture.Assembly,fixture.MeasurementBindings) &&
                    binding.MeasurementFactCount==2 &&
                    binding.ComponentIds.Count==2 &&
                    binding.Designators.SequenceEqual(new[]{"C1","R1"}) &&
                    binding.BindingFingerprint.Length==64 &&
                    (group1<9 || round==100),
                    "valid measurement/component execution binding must be accepted");
            }
        }
