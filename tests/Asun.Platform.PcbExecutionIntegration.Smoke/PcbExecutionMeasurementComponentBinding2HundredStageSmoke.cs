...
public static class PcbExecutionMeasurementComponentBinding2HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                ...
                {
                    ComponentId=PcbFeatureId.Create(i1%2==0 ? "UNKNOWN-ID" : "R1-ID")
                };
                Check(
                    !PcbExecutionMeasurementComponentBindingRuntime.IsValid(
                        fixture.ExecutionSnapshot,fixture.Assembly,binding) &&
                    (group1<9 || round==100),
                    "measurement component identity drift must be rejected");
            }
        }
        for(var group2=0;group2<10;group2++)
        {
            for(var i2=0;i2<10;i2++)
            {
                ...
                {
                    ComponentId=PcbFeatureId.Create(i2%2==0 ? "UNKNOWN-ID" : "R1-ID")
                };
                Check(
                    !PcbExecutionMeasurementComponentBindingRuntime.IsValid(
                        fixture.ExecutionSnapshot,fixture.Assembly,binding) &&
        ...
        for(var group3=0;group3<10;group3++)
        {
            for(var i3=0;i3<10;i3++)
            {
                ...
                {
                    ComponentId=PcbFeatureId.Create(i3%2==0 ? "UNKNOWN-ID" : "R1-ID")
                };
                Check(
                    !PcbExecutionMeasurementComponentBindingRuntime.IsValid(
                        fixture.ExecutionSnapshot,fixture.Assembly,binding) &&
        ...
        for(var group4=0;group4<10;group4++)
        {
            for(var i4=0;i4<10;i4++)
            {
                ...
                {
                    ComponentId=PcbFeatureId.Create(i4%2==0 ? "UNKNOWN-ID" : "R1-ID")
                };
                Check(
                    !PcbExecutionMeasurementComponentBindingRuntime.IsValid(
                        fixture.ExecutionSnapshot,fixture.Assembly,binding) &&
        ...
        for(var group5=0;group5<10;group5++)
        {
            for(var i5=0;i5<10;i5++)
            {
                ...
                {
                    ComponentId=PcbFeatureId.Create(i5%2==0 ? "UNKNOWN-ID" : "R1-ID")
                };
                Check(
                    !PcbExecutionMeasurementComponentBindingRuntime.IsValid(
                        fixture.ExecutionSnapshot,fixture.Assembly,binding) &&
        ...
        for(var group6=0;group6<10;group6++)
        {
            for(var i6=0;i6<10;i6++)
            {
                ...
                {
                    ComponentId=PcbFeatureId.Create(i6%2==0 ? "UNKNOWN-ID" : "R1-ID")
                };
                Check(
                    !PcbExecutionMeasurementComponentBindingRuntime.IsValid(
                        fixture.ExecutionSnapshot,fixture.Assembly,binding) &&
        ...
        for(var group7=0;group7<10;group7++)
        {
            for(var i7=0;i7<10;i7++)
            {
                ...
                {
                    ComponentId=PcbFeatureId.Create(i7%2==0 ? "UNKNOWN-ID" : "R1-ID")
                };
                Check(
                    !PcbExecutionMeasurementComponentBindingRuntime.IsValid(
                        fixture.ExecutionSnapshot,fixture.Assembly,binding) &&
        ...
        for(var group8=0;group8<10;group8++)
        {
            for(var i8=0;i8<10;i8++)
            {
                ...
                {
                    ComponentId=PcbFeatureId.Create(i8%2==0 ? "UNKNOWN-ID" : "R1-ID")
                };
                Check(
                    !PcbExecutionMeasurementComponentBindingRuntime.IsValid(
                        fixture.ExecutionSnapshot,fixture.Assembly,binding) &&
        ...
        for(var group9=0;group9<10;group9++)
        {
            for(var i9=0;i9<10;i9++)
            {
                ...
                {
                    ComponentId=PcbFeatureId.Create(i9%2==0 ? "UNKNOWN-ID" : "R1-ID")
                };
                Check(
                    !PcbExecutionMeasurementComponentBindingRuntime.IsValid(
                        fixture.ExecutionSnapshot,fixture.Assembly,binding) &&
        ...
        for(var group10=0;group10<10;group10++)
        {
            for(var i10=0;i10<10;i10++)
            {
                ...
                {
                    ComponentId=PcbFeatureId.Create(i10%2==0 ? "UNKNOWN-ID" : "R1-ID")
                };
                Check(
                    !PcbExecutionMeasurementComponentBindingRuntime.IsValid(
                        fixture.ExecutionSnapshot,fixture.Assembly,binding) &&
