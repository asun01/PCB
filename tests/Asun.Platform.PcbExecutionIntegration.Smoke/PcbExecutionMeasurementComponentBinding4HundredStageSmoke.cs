...
public static class PcbExecutionMeasurementComponentBinding4HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                ...
                var binding=i1%2==0
                    ? fixture.MeasurementBindings.Take(1).ToArray()
                    : fixture.MeasurementBindings.Concat(new[]{fixture.MeasurementBindings[1] with { Sequence=3 }}).ToArray();
                Check(
                    !PcbExecutionMeasurementComponentBindingRuntime.IsValid(
                        fixture.ExecutionSnapshot,fixture.Assembly,binding) &&
                    (group1<9 || round==100),
                    "measurement count/sequence drift must be rejected");
            }
        }
