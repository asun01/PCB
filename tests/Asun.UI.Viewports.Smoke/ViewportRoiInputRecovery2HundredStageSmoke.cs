...
public static class ViewportRoiInputRecovery2HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        var p1=new Vector2(40+2,30+2);
        var p2=new Vector2(120+2,90+2);
        ...
        assert(round==100,$"ViewportRoiInputRecovery2HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
