...
public static class ViewportInputRecovery1HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        assert(round==100,$"ViewportInputRecovery1HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
