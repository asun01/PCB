...
public static class ViewportInputRecovery3HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        assert(round==100,$"ViewportInputRecovery3HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
