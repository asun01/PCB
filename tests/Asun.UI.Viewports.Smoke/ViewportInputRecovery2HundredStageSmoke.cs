...
public static class ViewportInputRecovery2HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        assert(round==100,$"ViewportInputRecovery2HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
