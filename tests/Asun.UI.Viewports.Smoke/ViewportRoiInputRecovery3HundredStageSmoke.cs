...
public static class ViewportRoiInputRecovery3HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        var p1=new Vector2(40+3,30+3);
        var p2=new Vector2(120+3,90+3);
        ...
        assert(round==100,$"ViewportRoiInputRecovery3HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
