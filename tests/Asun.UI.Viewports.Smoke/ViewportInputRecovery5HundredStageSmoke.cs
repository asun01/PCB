...
public static class ViewportInputRecovery5HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        runtime.Complete(cancelPending:true);
        ...
        assert(round==100,$"ViewportInputRecovery5HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
