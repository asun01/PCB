...
public static class ViewportRoiInputRecovery5HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        var p1=new Vector2(40+5,30+5);
        var p2=new Vector2(120+5,90+5);
        ...
        assert(round==100,$"ViewportRoiInputRecovery5HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
