...
public static class ViewportRoiInputRecovery1HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        var p1=new Vector2(40+1,30+1);
        var p2=new Vector2(120+1,90+1);
        ...
        assert(round==100,$"ViewportRoiInputRecovery1HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
