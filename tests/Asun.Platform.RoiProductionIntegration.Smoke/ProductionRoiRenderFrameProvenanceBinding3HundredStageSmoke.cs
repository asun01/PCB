...
public static class ProductionRoiRenderFrameProvenanceBinding3HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                ...
                var render=fixture.RenderFrame with
                {
                    ProductionInputFingerprint="aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
                };
                Check(
                    !ProductionRoiRenderFrameProvenanceBindingRuntime.IsValid(
                        fixture.ProductionReport,fixture.RoiContext,fixture.Provenance,render) &&
                    (group1<9 || round==100),
                    "render input identity drift must be rejected");
            }
        }
