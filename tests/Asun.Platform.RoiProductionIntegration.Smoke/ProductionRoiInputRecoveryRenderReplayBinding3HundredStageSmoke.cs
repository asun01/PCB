...
public static class ProductionRoiInputRecoveryRenderReplayBinding3HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group0=0;group0<10;group0++)
        {
            for(var i0=0;i0<10;i0++)
            {
                ...
                var render=fixture.RenderContext with { RoiContextBindingFingerprint="aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa" };
                Check(
                    !ProductionRoiInputRecoveryRenderReplayBindingRuntime.IsValid(fixture.RoiContext,render) &&
                    (group0<9 || round==100),
                    "ROI binding drift must be rejected");
            }
        }
