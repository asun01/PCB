...
public static class ProductionRoiRenderFrameProvenanceBinding5HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                ...
                var left=ProductionRoiRenderFrameProvenanceBindingRuntime.Create(
                    fixture.ProductionReport,fixture.RoiContext,fixture.Provenance,fixture.RenderFrame);
                var right=ProductionRoiRenderFrameProvenanceBindingRuntime.Create(
                    fixture.ProductionReport,fixture.RoiContext,fixture.Provenance,fixture.RenderFrame);
                Check(
                    ProductionRoiRenderFrameProvenanceBindingRuntime.IsEquivalent(left,right) &&
                    left.RoiBindingFingerprint==right.RoiBindingFingerprint &&
                    left.RenderFingerprint==right.RenderFingerprint &&
                    (group1<9 || round==100),
                    "equivalent ROI/render/provenance inputs must converge");
            }
        }
