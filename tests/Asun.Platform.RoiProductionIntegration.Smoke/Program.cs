...
await ProductionRoiInputRecoveryRenderReplayBinding1HundredStageSmoke.RunAsync(Check);
await ProductionRoiInputRecoveryRenderReplayBinding2HundredStageSmoke.RunAsync(Check);
await ProductionRoiInputRecoveryRenderReplayBinding3HundredStageSmoke.RunAsync(Check);
await ProductionRoiInputRecoveryRenderReplayBinding4HundredStageSmoke.RunAsync(Check);
await ProductionRoiInputRecoveryRenderReplayBinding5HundredStageSmoke.RunAsync(Check);
