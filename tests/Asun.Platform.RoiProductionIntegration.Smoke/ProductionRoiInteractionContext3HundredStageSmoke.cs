...
public static class ProductionRoiInteractionContext3HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group0=0;group0<10;group0++)
        {
            round++;
                ...
                var tampered=f.Production with { SessionId=Guid.Parse("74000000-0000-0000-0000-000000000001") };
                Check(!ProductionRoiInteractionContextRuntime.IsValid(tampered,f.RoiSnapshot) &&
                      (group0<9 || round==100),
