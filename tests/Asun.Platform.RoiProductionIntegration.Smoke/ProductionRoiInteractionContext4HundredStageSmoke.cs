...
public static class ProductionRoiInteractionContext4HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group0=0;group0<10;group0++)
        {
            round++;
                ...
                var tampered=f.RoiSnapshot with { Fingerprint=new string('1',64) };
                Check(!ProductionRoiInteractionContextRuntime.IsValid(f.Production,tampered) &&
                      (group0<9 || round==100),
                      "ROI interaction fingerprint tampering must be rejected");
        }
