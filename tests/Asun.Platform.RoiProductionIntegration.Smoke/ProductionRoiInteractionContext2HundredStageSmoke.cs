...
public static class ProductionRoiInteractionContext2HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group0=0;group0<10;group0++)
        {
            round++;
                ...
                var tampered=f.RoiSnapshot with { RoiFingerprint=new string('0',64) };
                Check(!ProductionRoiInteractionContextRuntime.IsValid(f.Production,tampered) &&
                      (group0<9 || round==100),
                      "ROI fingerprint tampering must be rejected");
        }
