...
public static class ProductionRoiRenderFrameProvenanceBinding4HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                ...
                {
                    ProductionSessionId=Guid.Parse("c3000000-0000-0000-0000-000000000001")
                };
                Check(
                    !ProductionRoiRenderFrameProvenanceBindingRuntime.IsValid(
                        fixture.ProductionReport,roi,fixture.Provenance,fixture.RenderFrame) &&
                    (group1<9 || round==100),
                    "ROI Production session drift must be rejected");
            }
        }
