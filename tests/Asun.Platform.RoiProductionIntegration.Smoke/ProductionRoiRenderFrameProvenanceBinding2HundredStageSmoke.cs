...
public static class ProductionRoiRenderFrameProvenanceBinding2HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                ...
                {
                    PayloadFingerprint="9999999999999999999999999999999999999999999999999999999999999999"
                };
                Check(
                    !ProductionRoiRenderFrameProvenanceBindingRuntime.IsValid(
                        fixture.ProductionReport,fixture.RoiContext,provenance,fixture.RenderFrame) &&
                    (group1<9 || round==100),
                    "frame payload drift must be rejected");
            }
        }
