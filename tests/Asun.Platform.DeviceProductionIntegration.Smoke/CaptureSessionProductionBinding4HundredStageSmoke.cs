...
public static class CaptureSessionProductionBinding4HundredStageSmoke
{
    public static async ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        var program=new InspectionProgram(
            Guid.Parse("FE000000-0000-0000-0000-000000000004"),
            "CaptureProductionBinding",
            new Version(1,0,0),
            new[]{
                new ProgramStep(
                    Guid.Parse("FF000000-0000-0000-0000-000000000004"),
                    1,
        ...
        for(var i=0;i<10;i++) Check(binding.CapturedCount==5,"Binding should preserve capture frame count.");
        ...
        assert(round==100,$"CaptureSessionProductionBinding4HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
    }
}
