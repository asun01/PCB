...
public static class CaptureSessionProductionBinding1HundredStageSmoke
{
    public static async ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        var program=new InspectionProgram(
            ...
            new[]{
                new ProgramStep(
                    Guid.Parse("FF000000-0000-0000-0000-000000000001"),
                    1,
        ...
        for(var i=0;i<10;i++) Check(binding.CapturedCount==2,"Binding should preserve capture frame count.");
        ...
        assert(round==100,$"CaptureSessionProductionBinding1HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
    }
}
