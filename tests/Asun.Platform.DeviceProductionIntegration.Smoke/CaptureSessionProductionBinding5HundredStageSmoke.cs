...
public static class CaptureSessionProductionBinding5HundredStageSmoke
{
    public static async ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        var program=new InspectionProgram(
            Guid.Parse("FE000000-0000-0000-0000-000000000005"),
            "CaptureProductionBinding",
            new Version(1,0,0),
            new[]{
                new ProgramStep(
                    Guid.Parse("FF000000-0000-0000-0000-000000000005"),
                    1,
        ...
        for(var i=0;i<10;i++) Check(binding.CapturedCount==6,"Binding should preserve capture frame count.");
        ...
        assert(round==100,$"CaptureSessionProductionBinding5HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
    }
}
