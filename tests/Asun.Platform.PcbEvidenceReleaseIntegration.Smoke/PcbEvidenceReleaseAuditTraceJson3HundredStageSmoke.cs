...
public static class PcbEvidenceReleaseAuditTraceJson3HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        var tampered=serialized.Replace("\\"sequence\\":1","\\"sequence\\":3",StringComparison.Ordinal);
        ...
        assert(round==100,$"PcbEvidenceReleaseAuditTraceJson3HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
