...
public static class PcbEvidenceReleaseAuditTrace3HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        assert(round==100,$"PcbEvidenceReleaseAuditTrace3HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
