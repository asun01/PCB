...
public static class PcbEvidenceReleaseAuditTraceJson1HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        assert(round==100,$"PcbEvidenceReleaseAuditTraceJson1HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
