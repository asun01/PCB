...
public static class PcbEvidenceReleaseAuditTraceJson2HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        var tampered=serialized.Replace(trace.Fingerprint, new string('9',64), StringComparison.Ordinal);
        ...
        assert(round==100,$"PcbEvidenceReleaseAuditTraceJson2HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
