...
public static class PcbEvidenceReleaseAuditTrace5HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        assert(round==100,$"PcbEvidenceReleaseAuditTrace5HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
