...
public static class PcbEvidenceReleaseAuditTrace4HundredStageSmoke
{
    public static ValueTask RunAsync(Action<bool,string> assert)
    {
        ...
        assert(round==100,$"PcbEvidenceReleaseAuditTrace4HundredStageSmoke should execute exactly 100 numbered rounds; actual {round}.");
