...
public static class ProductionFrameMeasurementProvenanceBinding1HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                ...
                var binding=ProductionFrameMeasurementProvenanceBindingRuntime.Create(
                    fixture.Provenance,fixture.Measurement);
                Check(
                    ProductionFrameMeasurementProvenanceBindingRuntime.IsValid(
                        fixture.Provenance,fixture.Measurement) &&
                    ProductionFrameMeasurementProvenanceBindingRuntime.IsValidBinding(binding) &&
                    binding.Sequence==1 &&
                    binding.Width==1920 &&
                    binding.Height==1080 &&
                    binding.BindingFingerprint.Length==64 &&
                    (group1<9 || round==100),
                    "valid frame/measurement provenance binding must be accepted");
            }
        }
