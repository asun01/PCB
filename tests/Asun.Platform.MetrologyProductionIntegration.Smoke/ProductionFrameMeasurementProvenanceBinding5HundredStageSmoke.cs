...
public static class ProductionFrameMeasurementProvenanceBinding5HundredStageSmoke
{
    public static Task RunAsync(Action<bool,string> Check)
    {
        ...
        for(var group1=0;group1<10;group1++)
        {
            for(var i1=0;i1<10;i1++)
            {
                ...
                var left=ProductionFrameMeasurementProvenanceBindingRuntime.Create(
                    fixture.Provenance,fixture.Measurement);
                var right=ProductionFrameMeasurementProvenanceBindingRuntime.Create(
                    fixture.Provenance,fixture.Measurement);
                Check(
                    ProductionFrameMeasurementProvenanceBindingRuntime.IsEquivalent(left,right) &&
                    left.ProductionInputFingerprint==right.ProductionInputFingerprint &&
                    left.ObservationFingerprint==right.ObservationFingerprint &&
                    (group1<9 || round==100),
                    "equivalent frame/measurement provenance inputs must converge");
            }
        }
