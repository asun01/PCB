...
var left=ProductionMeasurementQualityEvidenceReleaseAuditReplayContextRuntime.Create(fixture.ReplayDescriptor,fixture.AuditBinding);
var right=ProductionMeasurementQualityEvidenceReleaseAuditReplayContextRuntime.Create(fixture.ReplayDescriptor,fixture.AuditBinding);
Check(ProductionMeasurementQualityEvidenceReleaseAuditReplayContextRuntime.IsEquivalent(left,right) && left.ReplayDescriptorFingerprint==right.ReplayDescriptorFingerprint && left.AuditReplayBindingFingerprint==right.AuditReplayBindingFingerprint && (group<9 || round==100),"equivalent audit replay inputs must converge");
            }
        }
