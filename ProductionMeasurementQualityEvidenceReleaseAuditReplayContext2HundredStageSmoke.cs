...
var audit=fixture.AuditBinding with { ProductionSessionId=Guid.Parse("b4000000-0000-0000-0000-000000000001") };
Check(!ProductionMeasurementQualityEvidenceReleaseAuditReplayContextRuntime.IsValid(fixture.ReplayDescriptor,audit) && (group<9 || round==100),"Production session drift must be rejected");
            }
        }
