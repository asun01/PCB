...
public static class ProductionMeasurementQualityEvidenceReleaseAuditReplayContext3HundredStageSmoke
{
...
var descriptor=fixture.ReplayDescriptor with { ReleaseManifestFingerprint="aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa" };
Check(!ProductionMeasurementQualityEvidenceReleaseAuditReplayContextRuntime.IsValid(descriptor,fixture.AuditBinding) && (group<9 || round==100),"manifest drift must be rejected");
            }
        }
