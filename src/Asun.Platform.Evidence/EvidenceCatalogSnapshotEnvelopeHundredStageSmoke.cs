...
public static class EvidenceCatalogSnapshotEnvelopeHundredStageSmoke
{
    public static void Run(Action<bool,string> assert)
    {
        ...
        for(var i=0;i<10;i++) Check(!EvidenceCatalogSnapshotEnvelopeValidationRuntime.IsValid(tampered with {Fingerprint=new string('a',64)}),"Tampered envelope should be rejected.");
