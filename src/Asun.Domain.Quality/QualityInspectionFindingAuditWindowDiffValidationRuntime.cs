...
public static class QualityInspectionFindingAuditWindowDiffValidationRuntime
{
    public static IReadOnlyList<string> Validate(
        QualityInspectionFindingAuditWindowDiff diff)
    {
        ...
        {
            errors.Add("Finding audit window diff result ids cannot be empty.");
        }
        ...
        {
            errors.Add("A result id cannot appear in multiple finding audit window diff categories.");
        }
