...
public static class QualityInspectionFindingAuditDiffValidationRuntime
{
    public static IReadOnlyList<string> Validate(
        QualityInspectionFindingAuditDiff diff)
    {
        ...
        {
            errors.Add("Finding audit diff ids must be valid.");
        }
        ...
        {
            errors.Add("A finding id cannot appear in multiple diff categories.");
        }
