...
var audit=i0%2==0
    ? fixture.AuditBinding with { AuditSequence=0 }
    : fixture.AuditBinding with { AuditTraceFingerprint="bad" };
Check(!ProductionMeasurementQualityEvidenceReleaseAuditReplayContextRuntime.IsValid(fixture.ReplayDescriptor,audit) && (group<9 || round==100),"audit sequence/trace drift must be rejected");
            }
        }
